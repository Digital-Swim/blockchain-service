...
describe('BitcoinAddress getAddress and getAddressType round-trip', () => {
    const networkTypes = ['mainnet', 'testnet', 'regtest'];
    const addressTypes = ['p2pkh', 'p2sh', 'p2wpkh', 'p2tr'];
    ...
    it('should throw for invalid address', () => {
        expect(() => getAddressType('invalid_address', 'mainnet')).to.throw('Unsupported or invalid Bitcoin address');
    });
});
