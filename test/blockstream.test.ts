...
import { blockstreamConfig } from '../src/config/blockstram.js';
...
describe('BlockstreamApiProvider', function () {
    ...
    it('should fetch transaction details', async () => {
        const txid = blockstreamConfig.network === "mainnet" ? "ad92e2eb89632a7325fa01c883a8c15451151e38f8e01af485982d1630308602" : "7b60810d0741bb960ff1294d7b3c8911fec387db42aca1f37b26bef321eebf28"
        const tx = await provider.getTransaction(txid);
        expect(tx).to.have.property('txid').that.equals(txid);
    });

    it('should fetch address info', async () => {
        const address = blockstreamConfig.network === "mainnet" ? "1PuJjnF476W3zXfVYmJfGnouzFDAXakkL4" : "tb1pnexuk5akmt54fj2n4qx4rhfmr0e5w6parza2kh7m0wgp3ejt2ajsgkcxqv";
